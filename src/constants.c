...
const Color COLOR_RED = {255, 0, 0, 255}; // Red
const Color COLOR_GREEN = {0, 255, 0, 255}; // Green
const Color COLOR_BLUE = {0, 0, 255, 255}; // Blue
...
// Background layers
const BackgroundLayer BACKGROUND_HILLS = {5, 5, 1280, 480};
const BackgroundLayer BACKGROUND_SKY   = {5, 495, 1280, 480};
const BackgroundLayer BACKGROUND_TREES = {5, 985, 1280, 480};
