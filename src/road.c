...
void resetSprites(Game* game) {
    ...
    // Place static billboards along the track
    /*
    addSprite(game, 20, &SPRITE_BILLBOARD07, -1);
    addSprite(game, 40, &SPRITE_BILLBOARD06, -1);
    addSprite(game, 60, &SPRITE_BILLBOARD08, -1);
    addSprite(game, 80, &SPRITE_BILLBOARD09, -1);
    addSprite(game, 100, &SPRITE_BILLBOARD01, -1);
    addSprite(game, 120, &SPRITE_BILLBOARD02, -1);
    addSprite(game, 140, &SPRITE_BILLBOARD03, -1);
    addSprite(game, 160, &SPRITE_BILLBOARD04, -1);
    addSprite(game, 180, &SPRITE_BILLBOARD05, -1);
    ...
    for (n = 1000; n < (totalSegments - 50); n += 100) {
        ...
        addSprite(game, n + randOffset, sprite, -side); // Add billboard with chosen side and offset
